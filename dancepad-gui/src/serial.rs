...
const DEFAULT_TIMEOUT: time::Duration = time::Duration::from_millis(200);
...
fn send(cmd: &Command, port: &mut SerialPort) {
...
fn wait_for_response(port: &mut SerialPort) -> Result<Response, ResponseError> {
